...
import '../../Controllers/CustomerDeviceToken.dart';
import '../../Controllers/price-controller.dart';
import '../../Models/cartModel.dart';
import '../../Utils/app-constants.dart';
import '../../Utils/placeOrderService.dart';
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            Obx(
              () => Text(
                " Total: Nrs  ${productPriceController.totalPrice.value.toStringAsFixed(1)} ",
